...
router.put("/update", authenticateToken_1.authenticateToken, userControllers_1.updateUser);
exports.default = router;
router.delete("/delete", authenticateToken_1.authenticateToken, userControllers_1.deleteUser);
